...
#ifndef MOTHERBOARD
  #define MOTHERBOARD BOARD_GTM32PRO
#endif
...
#define DEFAULT_XYZ_STEPS_PER_UNIT (  (XYZ_FULL_STEPS_PER_ROTATION) \
                                    * (XYZ_MICROSTEPS) \
                                    / double(XYZ_BELT_PITCH) \
                                    / double(XYZ_PULLEY_TEETH))
// default steps per unit for Kossel (GT2, 20 tooth)
#define DEFAULT_AXIS_STEPS_PER_UNIT { \
                                      DEFAULT_XYZ_STEPS_PER_UNIT, \
                                      DEFAULT_XYZ_STEPS_PER_UNIT, \
                                      DEFAULT_XYZ_STEPS_PER_UNIT, \
                                      760*1.1 \
                                    }
...
#define DEFAULT_ZJERK                 DEFAULT_XJERK // Must be sme as XY for delta
...
//#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_XY_FEEDRATE 150   // X and Y axes feedrate in mm/s (also used for delta printers Z axis)
